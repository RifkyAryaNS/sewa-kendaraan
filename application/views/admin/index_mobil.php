<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        <br>
        <center>
            <h3><b>Data Kendaraan Mobil</b></h3>
        </center>
        <br>
        <a class="btn btn-success btn-sm pull-right bi bi-plus" href="<?= base_url("admin/mobil/tambah") ?>">Tambah</a>
                ...
                <table class="table" id="myTable">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                <td><?= $no++ ?></td>
                                <td><?= $bil['merk_mobil']; ?></td>
                                <td><?= $bil['nama_mobil']; ?></td>
                                <td><?= $bil['no_pol']; ?></td>
                                <td><?= buatRupiah($bil['harga']); ?> / Hari</td>
                                <td>
                                    <a class="btn btn-warning btn-sm bi bi-pencil-fill" href="<?= base_url("admin/mobil/edit/{$bil['id']}") ?>"></a>
                                    <a class="btn btn-danger btn-sm bi bi-eraser-fill" onclick="return confirm('Apakah anda yakin untuk menghapus data?')" href="<?= base_url("admin/mobil/hapus/{$bil['id']}") ?>"></a>
                                </td>
                            </tr>
                        <?php endforeach;
                        ?>
