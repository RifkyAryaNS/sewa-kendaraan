<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <br>
        <form class="form-horizontal" method="post" action="<?= base_url('admin/mobil/edit_save') ?>" enctype="multipart/form-data">
            <div class="mb-3 row">
                <label for="nama" class="col-sm-2 col-form-label text-muted">ID Mobil</label>
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="id" name="id" value="<?= $mobil['id'] ?>" required readonly>
                    </div>
                </div>
            </div>
            <br>
