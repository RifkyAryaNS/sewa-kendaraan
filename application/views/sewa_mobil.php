<?php if ($this->session->userdata('email')) { ?>
    ...
    <div class="container-fluid">
        ...
        <br>
        <form class="form-horizontal" method="post" action="<?= base_url('pesanan/tambah_sewa_mobil') ?>" enctype="multipart/form-data">
            <br>
            <div class="mb-3 row">
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="merk_mobil" name="merk_mobil" value="<?= $mobil['merk_mobil'] ?>" required>
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="nama_kendaraan" name="nama_kendaraan" value="<?= $mobil['nama_mobil'] ?>" required>
                    </div>
                </div>
            </div>
            <br>
            <div class="mb-3 row">
                ...
                <div class="col-sm-6">
                    <div class="input-group">
                        <input type="text" class="form-control" id="no_pol" name="no_pol" value="<?= $mobil['no_pol'] ?>" required>
                    </div>
                </div>
            </div>
            <br>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-9">
                    <div class="row">
                        <div class="col-sm-2">
                            <img src="<?= base_url('assets/img/') . $mobil['image'] ?>" class="img-thumbnail">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="mb-3 row">
                ...
                <div class="col-sm-5">
                    ...
                    <a class="btn btn-success" href="<?= base_url('mobil'); ?>" type="submit"><i class="bi bi-box-arrow-left"></i> Kembali</a></li>
                </div>
            </div>
    </div>
    </div>
